...
let onSendMessageClick = () => {
	...
	let onNewMessageChange = (event) => {
		// передаем значение из тексареа в импортированный акшн креатор - бросаем вниз корзину
		// c с открытой крышкой (скобки -реализация)
		// c балкона сторе на веревке-пропс сбросили корзину-диспатч с запиской апдейкреатор,
		// в диспатч кладем эвент-текущее значение текс-эреа чтобы отправить в стор
